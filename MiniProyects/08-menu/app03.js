const menu = [
  ...
  const breakfast = menu.filter(type => (type.category == "breakfast"))
  const shakes = menu.filter(type => (type.category == "shakes"))
  const lunch = menu.filter(type => (type.category == "lunch"))
  const NewCategory = menu.filter(type => (type.category == "NewCategory"))
  ...
  function createItem(itemsMenu){
    const article = (document.createElement("article")).className("menu-item")
    const  img = (document.createElement("img")).className("item-ingo")
    img.src = itemsMenu.img
    const div = (document.createElement("div")).className("item-info")
    const header = document.createElement('header')
    const hHead = document.createElement('h4')
    hHead.innerHTML = menuItems.title
    const hBody = (document.createElement('h4')).className("price")
    hBody.innerHTML = menuItems.price

    const p = (document.createElement('p')).className("item-text")
